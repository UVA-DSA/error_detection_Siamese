...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun  2 15:49:44 2021
...
class TimeseriesNet_duralinput(nn.Module):
    def __init__(self,l1,l2):
        super(TimeseriesNet_duralinput,self).__init__()
...
for Task in Tasks:
    ...
    for i, G in enumerate(all_g):
        ...
        for fold in range(len(unique_ids)):
            ...
            model=TimeseriesNet_duralinput(8, 32)
            device = "cpu"
